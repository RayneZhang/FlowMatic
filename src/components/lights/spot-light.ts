...
const spotLight = AFRAME.registerComponent('spotlight', {
            ...
            if (dataType === 'vector') {
                ...
                if (attribute === 'light_direction') {
                    ...
                    if (this.data.switch) {
                        ...
                        this.el.object3D.rotateX(MathUtils.degToRad(15));
                    }
                }
            }
            if (dataType === 'Color') {
    ...
    initLight: function(): void {
        ...
        spotLightEntity.object3D.rotation.set(MathUtils.degToRad(165), 0, 0);
        ...
        lightBulbEntity.object3D.rotation.set(MathUtils.degToRad(70), 0, 0);
        ...
        volumetricEntity.object3D.rotation.set(MathUtils.degToRad(-15), 0, 0);
