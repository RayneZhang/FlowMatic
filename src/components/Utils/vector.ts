...
const vector = AFRAME.registerComponent('vector', {
    ...
    updatePlugs: function(): void {
        ...
        this.inputPlug.object3D.rotation.set(MathUtils.degToRad(90), 0, 0);
        this.outputPlug.object3D.position.set(0.12, magnitude + plugOffset, 0);
        this.outputPlug.object3D.rotation.set(MathUtils.degToRad(90), 0, 0);
    },
    ...
    setTorus: function(_latitude, _longitude, _position): void {
        ...
        _longitude.object3D.rotateY(MathUtils.degToRad(90));
        _longitude.object3D.rotateZ(MathUtils.degToRad(90));

        _latitude.object3D.rotateX(MathUtils.degToRad(90));
    },
    ...
    initTorus: function(_axis, _arrowUp, _arrowDown): void {
        ...
        arrowDownHead.object3D.rotation.set(0, 0, MathUtils.degToRad(30));
        ...
        arrowUpTail.setAttribute('material', 'color', 'green');
        arrowUpTail.object3D.rotation.set(0, 0, MathUtils.degToRad(-25));
        arrowUpHead.setAttribute('geometry', headGeometry);
        arrowUpHead.setAttribute('material', 'color', 'green');
        arrowUpHead.object3D.position.set(0.0866, -0.05, 0);
        arrowUpHead.object3D.rotation.set(0, 0, MathUtils.degToRad(150));

        _arrowDown.object3D.rotation.set(0, 0, MathUtils.degToRad(90));
        _arrowUp.object3D.rotation.set(0, 0, MathUtils.degToRad(90));
    },
    ...
    setMagnitudeArrow: function(): void {
        ...
        this.magnitudeUp.object3D.rotateX(MathUtils.degToRad(90));
        this.magnitudeDown.object3D.rotateX(MathUtils.degToRad(-90));
    ...
    pointAt: function(_subEntityBody, _position): void {
        ...
        _subEntityBody.object3D.rotateX(MathUtils.degToRad(90));
    },
    ...
    initAxis: function(): void {
        ...
        xAxis.object3D.rotation.set(0, 0, MathUtils.degToRad(90));
        ...
        zAxis.object3D.rotation.set(MathUtils.degToRad(90), 0, 0);
    ...
    updateVector: function(_timeDelta): void {
        ...
        const angleRad = MathUtils.degToRad(15 / 1000 * _timeDelta);
        const reverseAngleRad = MathUtils.degToRad(-15 / 1000 * _timeDelta);
