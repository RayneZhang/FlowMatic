...
const globalMenu = {
    ...
    init: function(): void {
        ...
        this.subMenu = {'Data': ['Random Color'], 'Operators': ['Darkness', 'Acceleration', 'Velocity', 'Plus', 'Subtract', 'Vector2Number', 'Number2Vector', 'Condition: Bool'], 'Assets': ['Box', 'Sphere', 'Vector', 'Switch', 'Slider'], 'Lights': ['Light'], 'Avatars': ['Headset', 'Left Controller', 'Right Controller']};
    ...
    loadModelInstance(_appendEl: any, _buttonId: number): void {
        ...
        switch (instanceName) {
            ...
            case 'Darkness': case 'Acceleration': case 'Velocity': case 'Plus': case 'Subtract': case 'Condition: Bool': case 'Vector2Number': case 'Number2Vector':{
